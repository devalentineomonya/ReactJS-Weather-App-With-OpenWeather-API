...
const OtherCities = () => {
  return (
    <Card className="col-span-4 mt-6 ml-4 shadow-[rgba(145,_158,_171,_0.3)_0px_0px_2px_0px,_rgba(145,_158,_171,_0.02)_0px_12px_24px_-4px] rounded-md bg-transparent">
      ...
      <CardContent className="pb-0">
        ...
        <Button className="w-full py-1 bg-transparent border-indigo-400" variant="outline" size="default">View All</Button>
      </CardContent>
    </Card>
  );
};
