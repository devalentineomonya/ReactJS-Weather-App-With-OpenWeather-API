...
const Navbar = () => {
  ...
  return (
    <header className={`w-full h-14 sticky top-0 flex items-center justify-center px-2 lg:px-0 border-b border-b-gray-200 dark:border-b-gray-600 backdrop-blur-sm z-10 ${showNavbar ? "hidden" : ""}`}>
